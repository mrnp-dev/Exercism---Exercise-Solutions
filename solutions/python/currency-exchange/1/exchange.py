...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    spread = spread / 100
    final_rate = exchange_rate + (spread * exchange_rate)
    init_exchange = exchange_money(budget, final_rate)
    
    return init_exchange - get_leftover_of_bills(init_exchange, denomination) 